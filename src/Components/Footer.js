...
export default function Footer(props) {
  ...
  return (
    <footer
      class={`p-4 bg-white shadow md:px-6 md:py-8 ${
        theme ? "bg-blacked" : "bg-offWhite"
      }`}
    >
      <div class="sm:flex sm:items-center sm:justify-center">
        <a
          href="https://capreign.com/"
        ...
        <ul class="flex flex-wrap items-center mb-6 text-sm text-lightGray sm:mb-0 ">
          ...
          <li>
            <a href="https://wa.me/9497656243" class="hover:underline">
              Contact
            </a>
          </li>
        </ul>
      ...
      <span class="block text-sm text-lightGray sm:text-center">
        © 2023{" "}
        <a href="https://kapreign.com/" class="hover:underline">
          Kapreign™
        </a>
        . All Rights Reserved.
      </span>
